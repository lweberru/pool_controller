...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    entities = [
        ...
        PoolChemSensor(coordinator, "energy_grid_to_load_kwh", None, "kWh", "mdi:transmission-tower-import", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_grid_to_load_kwh_daily", None, "kWh", "mdi:transmission-tower-import", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_grid_to_load_kwh_monthly", None, "kWh", "mdi:transmission-tower-import", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_grid_to_load_kwh_yearly", None, "kWh", "mdi:transmission-tower-import", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_solar_to_grid_kwh", None, "kWh", "mdi:transmission-tower-export", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_solar_to_load_kwh", None, "kWh", "mdi:solar-power", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_solar_to_load_kwh_daily", None, "kWh", "mdi:solar-power", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_solar_to_load_kwh_monthly", None, "kWh", "mdi:solar-power", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_solar_to_load_kwh_yearly", None, "kWh", "mdi:solar-power", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_total_load_kwh", None, "kWh", "mdi:home-lightning-bolt", device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_net", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_daily", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_monthly", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_yearly", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_feed_in_loss", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_feed_in_loss_daily", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_feed_in_loss_monthly", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_feed_in_loss_yearly", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_net_daily", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_net_monthly", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
        PoolChemSensor(coordinator, "energy_cost_net_yearly", None, "€", "mdi:currency-eur", state_class=SensorStateClass.MEASUREMENT, entity_category=EntityCategory.DIAGNOSTIC),
