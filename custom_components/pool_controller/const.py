...
# Dynamic target defaults (conservative)
DEFAULT_ENABLE_DYNAMIC_TARGET = False
DEFAULT_DYNAMIC_TARGET_WINTER_OFFSET = 4.0
DEFAULT_DYNAMIC_TARGET_SPRING_OFFSET = 2.0
DEFAULT_DYNAMIC_TARGET_SUMMER_OFFSET = -6.0
DEFAULT_DYNAMIC_TARGET_AUTUMN_OFFSET = 1.0
DEFAULT_DYNAMIC_TARGET_MIN_OFFSET = -6.0
DEFAULT_DYNAMIC_TARGET_MAX_OFFSET = 4.0
DEFAULT_DYNAMIC_TARGET_WEATHER_MAX_OFFSET = 2.0
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_TEMP = 0.45
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_FEELS_LIKE = 0.20
...
DEFAULT_DYNAMIC_TARGET_EMA_ALPHA = 0.12
