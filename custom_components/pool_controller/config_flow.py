...
class PoolControllerConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_calendars(self, user_input=None):
        ...
        return self.async_show_form(step_id="calendars", errors=errors, data_schema=vol.Schema({
    ...
    async def async_step_pv(self, user_input=None):
        ...
        curr = {**self.data}
        return self.async_show_form(step_id="pv", errors=errors, data_schema=vol.Schema({
