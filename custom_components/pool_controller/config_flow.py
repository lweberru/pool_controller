    ...
    async def async_step_logic(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_PV_SURPLUS_SENSOR, default=DEFAULT_PV_SENS): selector.EntitySelector(selector.EntitySelectorConfig(domain="sensor", device_class="power")),
    ...
    async def async_step_init(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                # Ermöglicht auch das Ändern der Sensoren im Zahnrad
