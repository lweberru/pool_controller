...
| Entity | Description |
|--------|-------------|
| `climate.<pool>_*` | Pool heater thermostat entity (select this as the controller entity in automations and the dashboard card). Presets: Auto, Baden, Chloren, Filtern, Abwesend, Wartung, Stromsparen, Boost, Manuell |
